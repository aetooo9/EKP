      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item  active ">
            <a class="nav-link active" href="UserAdd.php">
  ...
  <div class="col-xl-3 col-lg-6">
    ...
    <div class="container-fluid mt--7" >
      ...
      <div class="row" >
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <div class="row icon-examples">
                ...
                <input type="text"  name="UserName" class="form-control " value="<?php echo $UserRow['UserName']; ?>" placeholder="إسم المستخدم">
                <br>
                 <input type="password"  name="Password" class="form-control " value="<?php echo $UserRow['Password']; ?>" placeholder="كلمة المرور">
                <br>
                ...
                ?>
                <option value="<?php echo $row['UserTypeID']; ?>" <?php if($UserRow['UserTypeID']==$row['UserTypeID']) echo "selected";?>><?php echo $row['UserTypeName']; ?></option>
                <?php
                }
                ?>
                </select>
                ...
                if(isset($_POST['save'])){
                    ...
                    $sql = "insert into Users(UserName,Password,UserTypeID) values(?,?,?)";
                    $r = $conn->prepare($sql);
                    $r->bind_param("ssi",$UserName,$Password,$UserTypeID);
                    $e = $r->execute();
                    if($e){
                    ...
                    if(isset($_POST['upd'])){
                        ...
                        $sql = "update Users set UserName=?,Password=?,UserTypeID=? where UserID=?";
                        $r = $conn->prepare($sql);
                    $r->bind_param("ssii",$UserName,$Password,$UserTypeID,$UserID);
                    $e = $r->execute();
                        if($e){
        ...
        <td><a href="UserAdd.php?UserID=<?php echo $row['UserID'];?>">تعديل</a></td>
        </tr>
        <?php
          }
          ?>
