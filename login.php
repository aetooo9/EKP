...
if(isset($_POST['login'])){
    ...
    $sql = "select count(1) as num,UserTypeID FROM users where UserName=? and Password=? group by UserTypeID";
    $r = $conn->prepare($sql);
    ...
    if($row['num']>0){
        ...
        $MsgError = "اسم المستخدم او كلمة المرور غير صحيحة";
    }
...
<body class="bg-default">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-primary py-3 py-lg-6 pt-lg-6">
      <div class="container">
              ...
              <form role="form" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="اسم المستخدم" type="text" name="UserName">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <input type="submit" class="btn btn-primary my-4" value="تسجيل دخول" name="login">
                  <p style="color:red;">
                      <?php
                         echo @$MsgError;
                      ?>
  ...
  <script src="./assets/js/js-cookie/js.cookie.js"></script>
  <script src="./assets/js/jquery.scrollbar/jquery.scrollbar.min.js"></script>
  <script src="./assets/js/jquery-scroll-lock/dist/jquery-scrollLock.min.js"></script>
  <!-- Argon JS -->
